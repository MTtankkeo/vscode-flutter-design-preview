...
/// Defines a widget entry that appears in the Flutter Widget Preview list.
///
...
abstract class PreviewWidget {
  /// The label shown for this entry in the Flutter Widget Preview list.
  String get displayName;

  /// An optional group used to organize related entries.
  String? get groupName => null;

  /// Builds the widget displayed in the Flutter Widget Preview canvas.
