...
/// Applies the brightness selected in the Flutter Widget Preview toolbar to Flutter.
///
/// The Flutter Widget Preview runner updates this binding when the user switches
...
abstract final class PreviewBinding {
  ...
  /// The theme mode currently selected in the Flutter Widget Preview toolbar.
  static ThemeMode get themeMode => _themeMode;

  /// Changes the Flutter Widget Preview's theme mode and applies its effective brightness.
